...
const locales = {
  en: {
    ...
    footer: "Visuals adapt to your GitHub theme, while repository stars, pull request statuses, rankings, and summaries refresh automatically.",
    about: "🚀 About Me",
  ...
  "zh-CN": {
    ...
    footer: "视觉效果随 GitHub 主题自动适配，仓库 Stars、PR 状态、排名和摘要自动更新。",
    about: "🚀 关于我",
    openSource: "📦 开源项目",
